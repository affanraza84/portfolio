...
export const FEATURED_PROJECTS: Project[] = [
  {
    ...
    tagline: "Low-latency bidirectional messaging platform with distributed room state and security controls.",
    description:
      "Full-stack real-time communication platform supporting instant messaging, live presence tracking, and automated rate limiting.",
    category: "Full-Stack / Distributed Real-Time",
    isFeatured: true,
    problem:
      "Traditional polling causes heavy server overhead. Real-time messaging requires reliable bidirectional socket synchronization, state recovery across disconnects, and flood protection.",
    solution:
      "Engineered an event-driven WebSocket/Socket.io backend with Express, MongoDB persistence, Redis presence caching, and optimistic client-side UI updates.",
    keyFeatures: [
      "Sub-50ms message propagation with WebSockets",
      "Live typing indicators & Redis presence tracking",
      "JWT authentication with secure HTTP-only cookies",
      "Sliding-window rate limiting against spam attacks",
    ],
    techStack: [
      "Node.js",
      "Express.js",
    ...
    myRole:
      "Architected socket event protocols, backend APIs, rate-limiting middleware, MongoDB schemas, and responsive optimistic UI.",
    architectureHighlights: [
      "WebSocket connection lifecycle with exponential reconnect backoff",
      "Redis in-memory caching for volatile presence & active sessions",
    ],
    metricsOrHighlights: [
      "Sub-50ms message dispatch latency",
      "Zero message drops during socket reconnection",
    ],
  ...
  },
  {
    ...
    tagline: "Voice-enabled fitness companion generating personalized workout regimens and custom nutrition plans via Gemini AI.",
    description:
      "Full-stack AI fitness web application integrating Vapi voice conversational agents and Gemini LLM with Convex real-time database.",
    category: "Full-Stack AI & Voice",
    isFeatured: true,
    problem:
      "Static workout routines fail to adapt to individual injuries, dietary constraints, and fitness goals without expensive personal trainers.",
    solution:
      "Built a Next.js platform utilizing Vapi for interactive voice intake, Google Gemini for dynamic workout/diet program generation, and Convex for reactive real-time data sync.",
    keyFeatures: [
      "Conversational Voice AI assistant (Vapi) for fitness intake",
      "Custom workout routines & meal plans generated by Gemini AI",
      "Reactive real-time database & program management with Convex",
      "Multi-provider authentication & route security via Clerk",
    ],
    techStack: [
      "Next.js",
      "React",
    ...
    myRole:
      "Engineered full-stack app: Vapi voice agent flows, Gemini prompt pipelines, Convex real-time schema, Clerk auth, and Shadcn UI.",
    architectureHighlights: [
      "Voice intake pipeline bridging Vapi agents with Gemini LLM structured outputs",
      "Convex real-time subscriptions for zero-latency program state updates",
      "Secure user sessions and isolated program state via Clerk middleware",
    ],
    metricsOrHighlights: [
      "Real-time voice-driven fitness consultation",
      "Automated personalized workout & diet generation",
    ],
    liveUrl: "https://codeflex-ai-amber.vercel.app",
    githubUrl: "https://github.com/affanraza84/codeflex-ai",
  },
  {
    id: "tiny-vector-search",
    title: "Tiny Vector Search Engine",
    tagline: "Modular, in-memory vector similarity engine built from scratch in pure Python with exact Cosine math and REST API.",
    description:
      "A modular vector search engine implemented in Python 3.11+ without third-party vector databases, featuring exact cosine similarity, min-heap Top-K ranking, metadata pre-filtering, and FastAPI REST endpoints.",
    category: "Systems / Search & Information Retrieval",
    isFeatured: true,
    problem:
      "Commercial vector databases hide dense vector arithmetic behind complex C++ wrappers, making it difficult to understand embedding spaces, geometric similarity, time complexity trade-offs, and metadata filtering.",
    solution:
      "Engineered a zero-dependency vector engine in Python implementing pure cosine similarity math, O(N log K) min-heap nearest-neighbor retrieval, metadata pre-filtering, and atomic JSON disk persistence backed by FastAPI.",
    keyFeatures: [
      "Pure Python vector arithmetic (Cosine similarity, L2 norm, zero-vector safe)",
      "O(N log K) bounded Top-K candidate selection via min-heap priority queues",
      "Metadata pre-filtering and candidate ID set reduction before vector scoring",
      "Production-ready FastAPI REST API with Swagger documentation & Pydantic schemas",
    ],
    techStack: [
      "Python 3.11+",
      "FastAPI",
    ...
    myRole:
      "Architected the decoupled multi-layer system: vector math kernel, in-memory dimension-enforced storage, heap-based search index, metadata pre-filter, atomic disk persistence, and 48 automated tests.",
    architectureHighlights: [
      "Decoupled BaseVectorIndex interface allowing drop-in HNSW / ANN graph indexing",
      "Atomic disk persistence with corruption recovery and schema validation",
      "Comprehensive test suite (48 tests) covering edge cases and zero-magnitude vectors",
    ],
    metricsOrHighlights: [
      "Zero external vector DB dependencies",
      "48/48 unit & integration tests passing",
      "O(N log K) heap-bounded search latency",
    ],
    githubUrl: "https://github.com/affanraza84/vector-search-engine",
  },
];
...
export const OPEN_SOURCE_RECOGNITIONS: OpenSourceContribution[] = [
  {
    ...
    rank: "Elite Tier",
    description:
      "Contributed high-impact pull requests across open-source web and backend repositories, collaborating with maintainers on production bug fixes and UI performance.",
    highlights: [
      "Ranked in Top 1% globally based on merged PR complexity and velocity",
      "Resolved frontend state management bugs and responsive UI bottlenecks",
      "Optimized backend route handling and structured API documentation",
    ],
    skillsUsed: ["TypeScript", "React", "Node.js", "Git / GitHub"],
  },
  {
    ...
    rank: "Elite Tier",
    description:
      "Delivered modular frontend enhancements, component refactoring, and critical fixes across diverse open-source codebases.",
    highlights: [
      "Achieved Top 1% contributor standing across active global participants",
      "Built reusable UI components and modular utility libraries",
      "Collaborated asynchronously with maintainers following strict Git workflows",
    ],
    skillsUsed: ["Next.js", "Tailwind CSS", "TypeScript", "REST APIs"],
  },
  {
    ...
    rank: "Rank 64",
    description:
      "Earned Rank 64th globally in competitive open-source challenge by delivering high-velocity feature contributions and performance optimizations.",
    highlights: [
      "Ranked 64th globally across thousands of competitive participants",
      "Shipped modular frontend components and backend route optimizations",
      "Maintained linear Git commit history and comprehensive PR documentation",
    ],
    skillsUsed: ["TypeScript", "Next.js", "React", "Node.js", "Git"],
  },
];
...
export const EXPERIENCE_HISTORY: ExperienceItem[] = [
  {
    ...
    type: "Internship",
    summary:
      "Engineered a production B2B maritime freight platform with live rate operations, dynamic pricing engines, currency normalization, and automated SEO pipelines.",
    responsibilities: [
      "Built backend pricing logic and currency normalization pipelines to compute multi-currency freight quotes into USD.",
      "Engineered dynamic overweight charge rules with configurable weight thresholds and shipping-line evaluations.",
      "Developed reusable UI components including Port Autocomplete and booking forms backed by dynamic MongoDB APIs.",
      "Implemented comprehensive SEO architecture (JSON-LD structured data, Open Graph, dynamic XML sitemaps).",
    ],
    skillsApplied: [
      "Next.js",
      "React",
  ...
  },
  {
    ...
    type: "Internship",
    summary:
      "Developed component-based frontend architectures and integrated RESTful APIs with sub-second page performance.",
    responsibilities: [
      "Translated Figma UI/UX designs into pixel-perfect, accessible React and Next.js components.",
      "Integrated frontend applications with backend REST APIs, handling async state management and error boundaries.",
      "Optimized rendering performance and asset loading to improve Core Web Vitals and page load speeds.",
      "Participated in agile sprints, peer code reviews, and cross-browser compatibility testing.",
    ],
    skillsApplied: [
      "React",
      "Next.js",
  ...
  },
  {
    ...
    type: "Freelance",
    summary:
      "Successfully delivered 4 production-grade freelance projects with 100% on-time milestone delivery and client satisfaction.",
    responsibilities: [
      "Architected and deployed full-stack web applications using Next.js, React, TypeScript, and Node.js.",
      "Built secure backend REST APIs with JWT authentication and PostgreSQL/MongoDB database models.",
      "Configured automated production deployments on Vercel and cloud platforms with SSL and CI/CD pipelines.",
    ],
    skillsApplied: [
      "Next.js",
      "React",
